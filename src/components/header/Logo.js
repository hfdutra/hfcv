function Logo() {
    return (
        <svg id="logo" xmlns="http://www.w3.org/2000/svg"
            width="80px"
            viewBox="0 0 87.88 50.1">
            <defs>
                <style dangerouslySetInnerHTML={{ __html: "\n                    .arrow-left,\n                    .arrow-right {\n                        fill: #1f6feb;\n                    }\n\n                    body.dark svg g.hf {\n                        fill: white!important;\n                    }\n                    " }} />
            </defs>
            <g>
                <g>
                    <polygon className="arrow-left" points="7.03 28.47 13.74 38.38 6.71 38.38 0 28.47 6.71 18.57 13.74 18.57 7.03 28.47" />
                    <polygon className="arrow-right" points="80.85 14.41 74.14 4.51 81.17 4.51 87.88 14.41 81.17 24.32 74.14 24.32 80.85 14.41" />
                    <g className="hf">
